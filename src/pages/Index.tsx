  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="text-center bg-white text-black py-10 rounded-md shadow-slate-500 mt-5 px-4 md:px-6 ">
        <h2 className="text-2xl font-semibold">Join 1000+ Businesses!</h2>
        ...
        <div className="container px-4 md:px-6 mx-auto">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg mb-8 text-primary-foreground/80">
              Join thousands of businesses that trust KYCFabric for their
              verification needs.
            </p>
...
const features = [
  {
    ...
    description:
      "Verify identities using PAN, Aadhaar, Voter ID, Vehicle RC, and Passport details in one platform.",
    icon: ShieldCheck,
  },
  {
